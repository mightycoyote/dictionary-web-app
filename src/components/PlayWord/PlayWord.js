...
function PlayWord({ wordInfo }) {
  ...
  return (
    <>
      ...
      <button className={styles.button} onClick={() => audioRef.current.play()}>
        <svg
        ...
        >
          <title id="title">Play pronuncation</title>
          <g className={styles.svg} fill="#A445ED" fillRule="evenodd">
            <circle className={styles.circle} cx="37.5" cy="37.5" r="37.5" opacity=".25" />
